...
import com.example.orderapp.adapters.MenuListAdapter;
...
public class RestaurantMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0){
                    Toast.makeText(RestaurantMenuActivity.this, "Please add some item in cart!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    //implements interface MenuListAdapter.MenuListClickListener
    @Override
    ...
    public void onUpdateCartClick(Menu menu) {
        if(itemsInCartList.contains(menu)){//kiểm tra một phần tử có nằm trong mảng arraylist ko
