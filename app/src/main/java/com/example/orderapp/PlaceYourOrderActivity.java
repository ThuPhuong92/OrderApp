...
import com.example.orderapp.adapters.PlaceYourOrderAdapter;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private EditText inputName, inputAddress, inputCity, inputState,
            inputZip, inputCardNumber, inputCardExpiry, inputCardPin;
    private RecyclerView cartItemsRecyclerView;
    private TextView tvDeliveryCharge, tvSubtotalAmount, tvDeliveryChargeAmount,
            tvTotalAmount, buttonPlaceYourOrder;
    ...
    //KHOI TAO RecyclerView cac item bạn đã đặt
